...
@Component({
  selector: 'app-request-table-head',
  templateUrl: './request-table-head.component.html',
  styleUrls: ['./request-table-head.component.scss']
})
export class RequestTableHeadComponent implements OnInit {
