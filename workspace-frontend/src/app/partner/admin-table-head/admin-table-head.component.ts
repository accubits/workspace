...
@Component({
  selector: 'app-admin-table-head',
  templateUrl: './admin-table-head.component.html',
  styleUrls: ['./admin-table-head.component.scss']
})
export class AdminTableHeadComponent implements OnInit {
